...
mare mass more weight so maria occupy more of the far-field disk. The v14
tuning applies a small front-axis nearside presentation rotation so the larger
basins sit more naturally on the visible disk. The v15 tuning grows a broad
central-basin contribution and fades limb maria harder so the largest readable
mass sits on the face instead of leaving a small center basin and a larger edge
basin. The texture remains stable on the geometry moon without screen-space or
UV painted stamp artifacts. Surface tone uses separate normal-space FBM and
