...
- The `lunar-surface-map-v8` capture uses the LROC nearside mosaic as the shape
  ...
  A small normal-space FBM perturbation adds non-stamp surface tone without
  copying Shadertoy noise code.
