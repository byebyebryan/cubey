...
#include <cubey/scene/camera_manager.h>
...
class SceneEditQueue {
  public:
    ...
    [[nodiscard]] LightEditQueue3D& lights3d() noexcept {
        return lights3d_;
    }
...
class SceneReadView {
  public:
    ...
    [[nodiscard]] const LightReadView3D& lights3d() const noexcept {
        return lights3d_;
    }
