...
struct GltfMaterial {
    ...
    GltfTextureRef clearcoat_texture{};
    GltfTextureRef clearcoat_roughness_texture{};
    GltfTextureRef clearcoat_normal_texture{};
    math::Vec3 sheen_color_factor{0.0F, 0.0F, 0.0F};
    float sheen_roughness_factor = 0.0F;
    GltfTextureRef sheen_color_texture{};
    GltfTextureRef sheen_roughness_texture{};
    float anisotropy_strength = 0.0F;
    float anisotropy_rotation = 0.0F;
    GltfTextureRef anisotropy_texture{};
    ...
    GltfTextureRef iridescence_texture{};
    GltfTextureRef iridescence_thickness_texture{};
