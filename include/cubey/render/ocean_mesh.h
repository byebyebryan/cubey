...
#include "ocean_surface_config.h"
...
ocean_mesh_clipmap_config(const OceanSurfaceConfig& config) {
...
[[nodiscard]] inline float ocean_mesh_near_half_extent(const OceanSurfaceConfig& config) {
    return cubey::render::clipmap_grid_2d_near_half_extent(ocean_mesh_clipmap_config(config));
}

[[nodiscard]] inline float ocean_mesh_level_half_extent(const OceanSurfaceConfig& config,
                                                        std::uint32_t level) {
    return cubey::render::clipmap_grid_2d_level_half_extent(ocean_mesh_clipmap_config(config),
                                                            level);
}

[[nodiscard]] inline float ocean_mesh_near_cell_size(const OceanSurfaceConfig& config) {
    return cubey::render::clipmap_grid_2d_near_cell_size(ocean_mesh_clipmap_config(config));
}

[[nodiscard]] inline float ocean_mesh_level_cell_size(const OceanSurfaceConfig& config,
                                                      std::uint32_t level) {
...
[[nodiscard]] inline OceanMeshPatchList ocean_mesh_clipmap_patches(const OceanSurfaceConfig& config) {
    return cubey::render::clipmap_grid_2d_patches<kOceanMaxMeshPatches>(
        ocean_mesh_clipmap_config(config));
}

[[nodiscard]] inline std::uint32_t ocean_mesh_patch_count(const OceanSurfaceConfig& config) {
    validate_ocean_config(config);
    return cubey::render::clipmap_grid_2d_patch_count(config.mesh_lod_levels);
}

[[nodiscard]] inline std::uint32_t ocean_mesh_total_triangle_count(const OceanSurfaceConfig& config) {
...
[[nodiscard]] inline std::uint32_t ocean_mesh_total_vertex_count(const OceanSurfaceConfig& config) {
    const OceanMeshPatchList patches = ocean_mesh_clipmap_patches(config);
