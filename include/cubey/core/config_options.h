...
enum class RunConfigOptionId {
    ...
    OceanMeshCells,
    OceanMeshLodLevels,
    OceanHorizonTargetNearCell,
    OceanSurfaceShadingPolicy,
    OceanSelfShadowStrength,
    OceanSelfShadowSteps,
    OceanSelfShadowFarSteps,
    OceanShapeAntiRepeatStrength,
    OceanDetailAntiRepeatStrength,
    OceanDetailFilter,
    OceanCameraOrbitSpin,
    OceanSizeReference,
    ...
    OceanWireOverlay,
    OceanWireOpacity,
    OceanCloudReflectionSource,
    OceanCloudEnvironmentExtent,
    OceanCloudEnvironmentUpdateHz,
    OceanCloudPlanarResolutionScale,
    OceanCloudPlanarViewSteps,
    OceanCloudPlanarGuardBand,
