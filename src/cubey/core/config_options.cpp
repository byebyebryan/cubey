...
constexpr std::string_view kCloudAerialOrbitGroup = "Clouds/Aerial Orbit Experimental";
...
constexpr std::array<ConfigOptionDescriptor, 250> kRunConfigOptions{
    ...
    option(RunConfigOptionId::CloudDensityModel, "clouds.density_model", "--cloud-density-model",
           ...
           "Cloud density model. surface-volume is production; experimental-aerial-orbit and "
           "ref-density are compatibility/reference paths.",
    ...
    option(RunConfigOptionId::CloudDistanceMode, "clouds.distance_mode", "--cloud-distance-mode",
           ...
           "Experimental aerial/orbit distance regime: auto, local, orbit-shell, or blend-debug.",
    ...
    option(RunConfigOptionId::CloudOrbitRepresentation, "clouds.orbit_representation",
           ...
           "Experimental orbit cloud representation: volume or surface-shell.",
    ...
    option(RunConfigOptionId::CloudOrbitTransitionStart, "clouds.orbit_transition_start_m",
           ...
           "Experimental camera altitude where the broad orbit cloud shell starts blending in.",
           ConfigOptionType::Float, min_range(0.0)),
    option(RunConfigOptionId::CloudOrbitTransitionEnd, "clouds.orbit_transition_end_m",
           ...
           "Experimental camera altitude where the broad orbit cloud shell fully replaces local "
           "clouds.",
           ConfigOptionType::Float, min_range(0.0)),
    option(
        RunConfigOptionId::CloudFarShellStart, "clouds.far_shell_start_m",
        "--cloud-far-shell-start-m", "Far Shell Start", kCloudAerialOrbitGroup,
        "Experimental view-ray distance where high-altitude rays start preferring the orbit shell.",
        ConfigOptionType::Float, min_range(0.0)),
    option(RunConfigOptionId::CloudFarShellEnd, "clouds.far_shell_end_m", "--cloud-far-shell-end-m",
           ...
           "Experimental view-ray distance where high-altitude rays fully prefer the orbit shell.",
           ConfigOptionType::Float, min_range(0.0)),
    option(RunConfigOptionId::CloudFarShellStrength, "clouds.far_shell_strength",
           ...
           "Experimental far cloud shell contribution behind high-view local volume.",
           ConfigOptionType::Float, bounded_range(0.0, 1.5)),
    option(RunConfigOptionId::CloudOrbitDetailStrength, "clouds.orbit_detail_strength",
           ...
           "Experimental high-frequency detail retained by the broad orbit shell.",
           ConfigOptionType::Float, bounded_range(0.0, 1.0)),
    option(RunConfigOptionId::CloudOrbitDensityScale, "clouds.orbit_density_scale",
           ...
           "Experimental density multiplier for the broad orbit cloud shell.",
           ConfigOptionType::Float, bounded_range(0.0, 2.0)),
    option(RunConfigOptionId::CloudOrbitFill, "clouds.orbit_fill", "--cloud-orbit-fill",
           "Orbit Fill", kCloudAerialOrbitGroup,
           "Experimental fill bias for broad orbit cloud weather coverage.",
           ConfigOptionType::Float, bounded_range(0.0, 2.0)),
    option(RunConfigOptionId::CloudOrbitMotionStrength, "clouds.orbit_motion_strength",
           ...
           "Experimental motion multiplier for procedural orbit weather advection.",
           ConfigOptionType::Float, bounded_range(0.0, 4.0)),
    option(RunConfigOptionId::CloudOrbitShellExtinction, "clouds.orbit_shell_extinction",
           ...
           "Experimental extinction multiplier for cloud-top shell optical depth.",
           ConfigOptionType::Float, bounded_range(0.0, 8.0)),
    ...
    option(RunConfigOptionId::CloudHorizonLayer, "clouds.horizon_layer", "--cloud-horizon-layer",
           ...
           "Enable the experimental dedicated far-horizon cloud layer.", ConfigOptionType::Bool,
           no_range(), {}, "--no-cloud-horizon-layer"),
