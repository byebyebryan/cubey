...
orbit-controller, CPU job facade, PNG capture queue, SPIR-V file loading,
pipeline ownership, dynamic graphics pipeline setup, descriptor setup/write
helpers, compute pipeline setup, depth attachment setup,
