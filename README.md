...
orbit-controller, CPU job facade, SPIR-V file loading, pipeline ownership,
dynamic graphics pipeline setup, descriptor setup/write helpers, compute
pipeline setup, depth attachment setup, texture transfer/readback helpers, PNG
output helper, shared shader includes,
