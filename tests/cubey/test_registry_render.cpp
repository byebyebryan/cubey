...
std::span<const TestCase> render_test_cases() {
    static constexpr std::array tests{
        ...
        CUBEY_TEST(test_render_graph_compiled_precomputes_resource_usage_signature),
        ...
        CUBEY_TEST(test_render_graph_resource_set_rejects_incompatible_texture_requirements),
        ...
        CUBEY_TEST(test_render_resource_table_rebinds_move_only_resource_without_reconstruction),
        ...
        CUBEY_TEST(test_shader_package_dependency_helpers_return_composed_lists),
