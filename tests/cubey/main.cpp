...
int main() {
    try {
        ...
        test_transform_hierarchy_2d_computes_lazy_world_affine_matrices();
        test_transform_hierarchy_3d_updates_world_affine_matrices();
        test_transform_hierarchy_reparenting_preserves_local_transform();
        test_transform_hierarchy_rejects_invalid_parenting();
