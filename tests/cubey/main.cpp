...
int main() {
    try {
        ...
        test_camera_3d_supports_orthographic_projection();
        ...
        test_engine_attaches_gpu_services_to_project_context();
        ...
        test_gpu_runtime_mark_submission_completed_updates_completed_ticket();
        ...
        test_gpu_runtime_preserves_pending_work_after_callback_failure();
        ...
        test_light_manager_publishes_3d_packets_from_scene_read_view();
        test_light_manager_updates_keep_epoch_local_snapshots();
        test_light_manager_entity_destroy_retires_attached_components();
        test_light_manager_rejects_invalid_edits();
        test_light_manager_skips_invisible_lights_without_transform();
        test_light_packets_require_transform_for_point_lights();
        ...
        test_project_gpu_services_tracks_failed_rgba8_readbacks();
        test_project_gpu_services_rejects_invalid_rgba8_readback_requests();
        ...
        test_project_runtime_adapter_attaches_gpu_services_to_context();
        ...
        test_render_target_views_describe_color_only_targets();
        test_render_target_rendering_info_describes_dynamic_rendering();
        test_depth_only_rendering_info_describes_sampled_depth_target();
        test_texture_2d_config_maps_storage_sampled_usage();
        test_texture_2d_config_maps_transfer_sampled_usage();
        test_depth_texture_config_maps_sampled_depth_usage();
        ...
        test_sampler_config_describes_shadow_sampling();
        ...
        test_submission_coordinator_issues_monotonic_gpu_tickets();
        test_submission_coordinator_submit_and_wait_marks_completion();
        test_submission_coordinator_completion_tracking_rejects_future_tickets();
        test_submission_coordinator_failed_submit_does_not_issue_ticket();
