...
void test_frame_stats_publish_window_title_metrics() {
    cubey::FrameStats stats(0.5);

    std::optional<cubey::FrameStatsSnapshot> first = stats.record_frame({
        .delta_seconds = 0.25,
        .width = 100,
        .height = 50,
        .triangles = 12,
    ...
    std::optional<cubey::FrameStatsSnapshot> second = stats.record_frame({
        .delta_seconds = 0.25,
        .width = 100,
        .height = 50,
        .triangles = 12,
    ...
    const cubey::FrameStatsSnapshot snapshot = *second;
    ...
    const std::string title = cubey::format_window_title("cubey textured_cube", snapshot);
