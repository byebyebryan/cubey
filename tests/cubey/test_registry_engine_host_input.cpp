...
std::span<const TestCase> engine_host_input_test_cases() {
    static constexpr std::array tests{
        ...
        CUBEY_TEST(test_staged_resource_shutdown_discards_superseded_install_on_gpu_owner),
        ...
        CUBEY_TEST(test_gltf_scene_importer_routes_transmission_independently_of_alpha_and_shadows),
