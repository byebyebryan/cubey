...
const float TERRAIN_REF_RECIPE_SHADERTOY_EROSION_BASE = 11.0;
const float TERRAIN_REF_RECIPE_SHADERTOY_EROSION_FILTERED = 12.0;
const float TERRAIN_REF_EROSION_PROCESS_OFFSET = 0.25;

const float TERRAIN_REF_MATERIAL_RECIPE = 0.0;
const float TERRAIN_REF_MATERIAL_HEIGHT = 1.0;
const float TERRAIN_REF_MATERIAL_EROSION = 2.0;
