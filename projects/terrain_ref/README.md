...
shader-side height sampler and procedural material presentation over a Cubey
clipmap review mesh.
...
is shader-generated rather than authored texture data, and there is no biome,
...
ShaderToy-style terrain plus rendering reference pass, a real water pass with
scene color/depth inputs, stronger shared atmosphere/lighting, tessellation/LOD
