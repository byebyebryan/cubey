...
water is a tint/clamp rather than reflection/refraction, and there is no biome,
hydrology, foliage, streaming, or planet-scale paging.
...
Next rendering work should improve presentation before adding more terrain
models: material detail, lighting/fog integration, water presentation, and a
less finite-looking view-centered mesh.
