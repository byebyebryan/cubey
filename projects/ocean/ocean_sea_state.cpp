...
OceanSeaStateSettings ocean_sea_state_settings(OceanSeaState state) {
    ...
    case OceanSeaState::Calm:
        return {
            .cascades =
                {
                    OceanSeaStateCascadeSettings{.displacement_scale = 0.60F,
                                                 ...
                                                 .whitecap = 0.18F,
                                                 .foam_amount = 1.0F},
                    OceanSeaStateCascadeSettings{.displacement_scale = 0.42F,
                                                 .normal_scale = 0.60F,
                                                 .wind_speed = 4.0F,
            ...
            .roughness = 0.22F,
            .normal_strength = 0.75F,
            .surface_foam_strength = 0.35F,
            .foam_history_strength = 0.40F,
            .foam_density = 1.20F,
            .foam_sharpness = 0.58F,
    ...
    case OceanSeaState::Windy:
        return {
            .cascades =
                {
                    OceanSeaStateCascadeSettings{.displacement_scale = 1.0F,
                                                 .normal_scale = 1.05F,
                                                 .wind_speed = 11.0F,
                                                 ...
                                                 .whitecap = 0.72F,
                                                 .foam_amount = 3.50F},
                    OceanSeaStateCascadeSettings{.displacement_scale = 0.78F,
                                                 .normal_scale = 0.95F,
                                                 .wind_speed = 9.0F,
            ...
            .roughness = 0.32F,
            .normal_strength = 0.90F,
            .surface_foam_strength = 0.85F,
            .foam_history_strength = 0.75F,
            .foam_density = 2.80F,
            .foam_sharpness = 0.60F,
    ...
    case OceanSeaState::Stormy:
        return {
            .cascades =
                {
                    OceanSeaStateCascadeSettings{.displacement_scale = 1.35F,
                                                 .normal_scale = 1.35F,
                                                 .wind_speed = 18.0F,
                                                 ...
                                                 .whitecap = 0.50F,
                                                 .foam_amount = 5.80F},
                    OceanSeaStateCascadeSettings{.displacement_scale = 1.08F,
                                                 .normal_scale = 1.35F,
                                                 .wind_speed = 16.0F,
            ...
            .surface_foam_strength = 1.0F,
            .foam_history_strength = 1.0F,
            .foam_density = 3.15F,
