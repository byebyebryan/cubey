...
[[nodiscard]] bool ocean_config_matches_sea_state(const OceanConfig& config, OceanSeaState state);
[[nodiscard]] OceanSeaState ocean_infer_sea_state(const OceanConfig& config);
