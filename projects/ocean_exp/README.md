...
`ocean_exp` is a temporary preservation copy of the active `ocean` renderer from
the point where the renderer had drifted away from the frozen `ocean_ref`
baseline. Keep it as a side-by-side comparison target while `projects/ocean` is
pulled back toward the reference wave core.

This project is not a new permanent lane. It exists so the macro cascades,
atmosphere integration, terrain-field descriptors, expanded foam composition,
and debug views can be inspected or selectively ported without keeping that
complexity in the active renderer by default.
...
```sh
./build/dev/projects/ocean_exp/ocean_exp --headless --frames 120 --width 1280 --height 720 --output /tmp/cubey-ocean-exp.png
```

Useful debug views:

```sh
./build/dev/projects/ocean_exp/ocean_exp --debug-view displacement
./build/dev/projects/ocean_exp/ocean_exp --debug-view normal
./build/dev/projects/ocean_exp/ocean_exp --debug-view foam
./build/dev/projects/ocean_exp/ocean_exp --debug-view foam-source
./build/dev/projects/ocean_exp/ocean_exp --debug-view foam-history
./build/dev/projects/ocean_exp/ocean_exp --debug-view foam-macro
./build/dev/projects/ocean_exp/ocean_exp --debug-view foam-crest
./build/dev/projects/ocean_exp/ocean_exp --debug-view foam-detail
./build/dev/projects/ocean_exp/ocean_exp --debug-view lod
./build/dev/projects/ocean_exp/ocean_exp --debug-view sky-radiance
./build/dev/projects/ocean_exp/ocean_exp --debug-view reflection
./build/dev/projects/ocean_exp/ocean_exp --debug-view direct-light
./build/dev/projects/ocean_exp/ocean_exp --debug-view ambient-light
./build/dev/projects/ocean_exp/ocean_exp --debug-view exposure
./build/dev/projects/ocean_exp/ocean_exp --debug-view terrain-depth
./build/dev/projects/ocean_exp/ocean_exp --debug-view terrain-shore
./build/dev/projects/ocean_exp/ocean_exp --debug-view terrain-slope
./build/dev/projects/ocean_exp/ocean_exp --debug-view lod --ocean-wire-overlay
./build/dev/projects/ocean_exp/ocean_exp --debug-view displacement --ocean-cascade 2
./build/dev/projects/ocean_exp/ocean_exp --no-ocean-spectral-domains
./build/dev/projects/ocean_exp/ocean_exp --ocean-terrain-fields
```
