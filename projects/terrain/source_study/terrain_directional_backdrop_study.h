...
enum class TerrainRadialFidelity : std::uint8_t {
    Control,
    Source,
    Material,
    Combined,
...
[[nodiscard]] std::string_view
terrain_radial_fidelity_name(TerrainRadialFidelity fidelity) noexcept;
[[nodiscard]] TerrainRadialFidelity terrain_radial_fidelity_from_name(std::string_view name);
[[nodiscard]] bool
terrain_radial_fidelity_uses_source_detail(TerrainRadialFidelity fidelity) noexcept;
[[nodiscard]] bool
terrain_radial_fidelity_uses_material_detail(TerrainRadialFidelity fidelity) noexcept;
