...
int main(int argc, char** argv) {
        ...
        for (const TerrainPreset preset : kPresets) {
            ...
            for (const std::uint64_t seed : kSeeds) {
                ...
                plans.push_back({
                    ...
                    {"minimum_target_distance_m", plan.minimum_target_distance_m},
                    ...
                    {"safe_zone_radius_m", plan.safe_zone_radius_m},
                    {"yaw_half_angle_radians", plan.yaw_half_angle_radians},
                    {"safe_zone_foreground_min_margin_m", plan.safe_zone_foreground_min_margin_m},
                    {"safe_zone_near_frame_test_distance_m",
                     plan.safe_zone_near_frame_test_distance_m},
                    {"safe_zone_near_frame_max_occluded_ray_count",
                     plan.safe_zone_near_frame_max_occluded_ray_count},
                    {"safe_zone_lower_frame_test_distance_m",
                     plan.safe_zone_lower_frame_test_distance_m},
                    {"safe_zone_lower_frame_max_occluded_ray_count",
                     plan.safe_zone_lower_frame_max_occluded_ray_count},
                    {"far_field_contract_satisfied", plan.far_field_contract_satisfied},
    ...
    const nlohmann::json report{
        {"schema", "cubey.terrain.backdrop-camera.v5"},
        ...
        {"far_field_v1_sample_distances_m", {3400, 6600}},
        ...
        {"far_field_v1_safe_zone_radius_m", 200},
        {"far_field_v1_yaw_half_angle_degrees", 30},
        {"far_field_v1_minimum_target_distance_m", 3200},
        {"far_field_v1_near_frame_test_distance_m", 2400},
        {"far_field_v1_lower_frame_test_distance_m", 1200},
        {"far_field_v1_lower_frame_maximum_occluded_rays", 2},
