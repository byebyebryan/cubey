...
void test_run_config_mapping() {
    ...
    run_config.clouds.weather_influence = 0.4F;
    ...
    require_near(config.weather_influence, 0.4F, 0.001F,
                 "cloud weather influence should map");
    ...
    require_near(config.orbit_fill, 1.40F, 0.001F, "cloud orbit fill should map");
...
void test_weather_preset_defaults() {
    ...
    require_near(config.orbit_fill, 1.0F, 0.001F,
                 "default orbit fill should preserve the tuned orbit weather coverage");
...
void test_config_descriptors() {
    ...
    cubey::set_run_config_option_from_string(config, "clouds.weather_influence", "0.4");
    ...
    require_near(config.clouds.weather_influence, 0.4F, 0.001F,
                 "cloud weather influence descriptor should set");
    ...
    require_near(config.clouds.orbit_fill, 1.40F, 0.001F,
                 "cloud orbit fill descriptor should set");
