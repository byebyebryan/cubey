...
struct OceanRefGpuResourceConfig {
...
class OceanRefGpuResources {
  public:
    OceanRefGpuResources() = default;
    ~OceanRefGpuResources() = default;

    OceanRefGpuResources(const OceanRefGpuResources&) = delete;
    OceanRefGpuResources& operator=(const OceanRefGpuResources&) = delete;

    void create(const cubey::vulkan::Device& device, const OceanRefGpuResourceConfig& config);
    void reset();
  ...
  private:
    using TextureArray = std::array<std::optional<cubey::render::Texture2D>, kOceanRefCascadeCount>;
    using FieldTextureArray = std::array<std::optional<cubey::render::Texture2D>,
                                         kOceanRefCascadeCount * kOceanRefSpectrumFieldCount>;

    void create_textures(const cubey::vulkan::Device& device, const OceanRefConfig& config);
