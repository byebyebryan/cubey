...
#include "ocean_ref_atmosphere.glsl"
...
layout(push_constant) uniform OceanRefParams {
...
const uint OCEAN_REF_VIEW_FINAL = 0u;
const uint OCEAN_REF_VIEW_HEIGHT = 1u;
