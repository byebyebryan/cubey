...
namespace cubey {
	...
	struct Event {
		...
		T4 para_4;
		Event() {}
		Event(const T0& p_0) : para_0(p_0) {}
		Event(const T0& p_0, const T1& p_1) : para_0(p_0), para_1(p_1) {}
		Event(const T0& p_0, const T1& p_1, const T2& p_2) : para_0(p_0), para_1(p_1), para_2(p_2) {}
		Event(const T0& p_0, const T1& p_1, const T2& p_2, const T3& p_3) : para_0(p_0), para_1(p_1), para_2(p_2), para_3(p_3) {}
		Event(const T0& p_0, const T1& p_1, const T2& p_2, const T3& p_3, const T4& p_4) : para_0(p_0), para_1(p_1), para_2(p_2), para_3(p_3), para_4(p_4) {}
	};
