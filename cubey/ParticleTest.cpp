...
namespace cubey {
	...
	void ParticleTest::Init() {
		...
		TwAddVarRW(UI::Main()->tw_bar_, "stream velocity min", TW_TYPE_FLOAT, &streams_min_vel_, "min=0.5 max=10 step=1");
		TwAddVarRW(UI::Main()->tw_bar_, "stream velocity max", TW_TYPE_FLOAT, &streams_max_vel_, "min=0.5 max=20 step=1");
