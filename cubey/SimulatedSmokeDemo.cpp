...
namespace cubey {
	...
	void SimulatedSmokeDemo::Init() {
		...
		temperature_injection_radius_ = 0.4f;
		temperature_injection_intensity_ = 1.5f;

		density_injection_radius_ = 0.8f;
		...
		TwAddVarRW(UI::Main()->tw_bar_, "temperature inject radius", TW_TYPE_FLOAT, &temperature_injection_radius_, "min=0.1 max=1.0 step=0.1 group=Injection");
		...
		TwAddVarRW(UI::Main()->tw_bar_, "density inject radius", TW_TYPE_FLOAT, &density_injection_radius_, "min=0.1 max=1.0 step=0.1 group=Injection");
